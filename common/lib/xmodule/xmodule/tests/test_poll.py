...
class PollModuleTest(LogicTest):
    ...
    def test_poll_export_with_unescaped_characters_xml(self):
        ...
        invalid_characters_poll_answer['text'] = '< 18'  # invalid greater-than character.
        output.answers[0] = invalid_characters_poll_answer
        output.save()

        xml = output.definition_to_xml(None)
        child_texts = xml.xpath('//text()')  # extract texts of all children.
        self.assertEqual(child_texts[3], '< 18')
