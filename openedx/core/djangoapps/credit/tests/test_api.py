...
class CreditRequirementApiTests(CreditApiTestBase):
    ...
    def test_user_eligibility_with_non_verified_enrollment(self, mode):
        ...
        User can not become credit eligible if he has non-verified enrollment in the course.
        """
        self.add_credit_course()
        ...
        # Set the requirement to "satisfied" and check that they are not set for non-credit enrollment.
