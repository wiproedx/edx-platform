  ...
  Markdown.makeWmdEditor = (elem, appended_id, imageUploadUrl, postProcessor) ->
    ...
    if not $elem.find(".wmd-panel").length
      ...
      $wmdPanel = $("<div>").addClass("wmd-panel")
                 ...
                 .append($("<textarea>").addClass("wmd-input").attr("id", wmdInputId).attr("placeholder", "Enter your post here. To help protect your privacy, don't include personal information, like your name or email address.")
